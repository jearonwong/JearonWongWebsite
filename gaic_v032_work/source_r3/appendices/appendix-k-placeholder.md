...
| R-K-16 | Phase 1C follow-up / Phase 1D-11 | Claim-level L2 product/protocol source binding remained pending | Created claim evidence register; Phase 1D-11 closed high-risk source pointers by official source replacement, claim narrowing, L5 downgrade, and explicit limitations | Claim evidence register; citation inventory; source coverage matrix; Appendix G | Closed for publication-candidate review; Appendix G remains provisional |
...
| Appendix I source audit boundary | Revalidation register could be misread as completed validation | Stated that source closure supports publication-candidate review but not legal, audit, certification, or procurement conclusions | Preserve explicit limitations during final proofing | Phase 1B-10 / Phase 1C / Phase 1D-11 |
...
|--------|--------|--------------|-------------------|----------------|
| Source-bound product/protocol claim proofing | Phase 1D-11 closed high-risk blockers, but final human proofing should preserve narrowed wording | Publication-candidate review | Closure ledger and rendered References / Sources section | Non-blocking limitation |
| Validation Lab methodology-specific citation | Methodology page is pinned; support remains public-surface and non-certifying | Publication-candidate review | Methodology URL plus boundary note | Non-blocking limitation |
| Evidence level source-to-claim rendering check | Evidence confidence is tied to claims and rendered in artifacts | Publication-candidate review | Citation/evidence rendering QA record | Non-blocking limitation |
| Appendix G revalidated provisional proofread | Provisional postures now have source binding but remain non-final | Publication-candidate review | Final no-score/no-ranking grep and citation check | Non-blocking limitation |
| DOCX/PDF generation and visual QA | HTML/PDF/DOCX derivative generated through Phase 1D-11 | Publication-candidate review | HTML/PDF/DOCX artifacts and visual QA report | Non-blocking limitation |
