...
|---|---|---|---|
| WP2 status | "internal R2 draft"; "source-grounded draft"; "planned white paper" | "published"; "final"; "sealed"; "publication candidate" | "internal draft prepared for R3 editorial/source/boundary QA" |
...
- Use this appendix as a grep-driven QA reference before publication candidate work.
- Confirm all future public text uses "internal draft" until publication wave.
