...
| Check | Result |
|---|---|
| Active source files rendered | 30 |
| Chapter headings retained | 9 |
| Appendix headings retained | 11 |
| F-01 through F-11 retained | PASS |
| Missing figures | none |
| Appendix G no-score note present | PASS |
| Conclusion thesis block present | PASS |
