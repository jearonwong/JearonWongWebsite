...
|---|---|---:|---|---|
| RCCS-T / RCCS-M / ALCS Provisional Analytical Score Comparison | Grouped bar SVG | 8 systems x 2 scores | Shows RCCS-T, RCCS-M, and ALCS score/range differences | Fixed order, not ranking |
| RCCS-M / ALCS Provisional Analytical Score Map | Score quadrant SVG | 8 systems | Shows posture pattern across governance coverage and lifecycle conformance | Not a leaderboard or procurement quadrant |
