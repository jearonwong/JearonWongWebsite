# AIAAWP R4 Source Register

**Status:** R4 publication-candidate preparation source register
**Boundary:** Sources listed here are used for context, terminology, grounding, or boundary discipline. Inclusion does not imply endorsement of this paper, GAIC, MPLP, AARM, Validation Lab, or Jearon Wong.
...
| BF-02 | Assurance for AI | PwC | Big Four market context | AI assurance market context | 0, 1, 14, 15 | Paraphrase only | Context only; not validation of this paper. |
...
| AUD-01 | AS 1105: Audit Evidence | PCAOB | Audit/professional body | Audit evidence terminology and sufficiency/appropriateness framing | 0, 3, 4, 5, 6, 7, 13, 16 | Paraphrase; short definition quote only if later approved | This paper is not a PCAOB audit standard. |
| AUD-02 | ISA 500 (Revised), Audit Evidence | IAASB | Audit/professional body | Audit evidence and technology-enabled evidence context | 3, 4, 7, 13 | Paraphrase only | This paper is not ISA methodology. |
| AUD-03 | ISAE 3000 (Revised) | IAASB | Audit/professional body | Assurance engagement boundary | 1, 12, 13, 15, 16 | Paraphrase only | This paper does not issue assurance conclusions. |
| AUD-04 | Trust Services Criteria | AICPA | Audit/professional body | Control vocabulary, monitoring, privacy/security, control activities | 5, 7, 8, 10, 11, 14 | Paraphrase only | This paper is not SOC or attestation guidance. |
...
| BOUND-03 | Attestation standards | AICPA | Audit/professional body | Attestation and practitioner-report boundary | 12, 13, 15 | Paraphrase only | This paper is not an attestation engagement. |
...
## R4 Source Register Result

**PASS - all sources used in the R4 candidate source are drawn from the R0 inventory or GAIC source truth.**


## R4 Citation Style

R4 uses source IDs in text, tables, and source notes with this register as the package-level lookup. Public endnote or footnote formatting remains a later publication-candidate QA decision.
